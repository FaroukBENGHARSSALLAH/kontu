...
public class ABCParser  {
	 ...
	 public LinkedList<ABCNews> getNews() {
				     ...
				     protected String getPictureURL(XMLEvent event, XMLEventReader eventReader) throws XMLStreamException {
				     ...
				     protected String generateReference(ABCNews news, String source) {
